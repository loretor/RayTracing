...
void main() {	
	...
	*/
	...
	geometries[13] = Geometry(PLANE, material, vec3(0.0), 0.0f, vec3(10.0, 0.0, 34.0), vec3(-1.0f, 0.0f, 0.0f), vec3(0.0f, 0.0f, 1.0f), vec3(0.0f, 1.0f, 0.0f), 10.0, 10.0); //fondo box3
